...
- `thin_plate_3d` charge-correct at res=12: Ex + function n(x,y), d=0.7λ (spiral peaks at ℓ=+1)
- Full-wave disk cache under `outputs/fullwave_cache/` (`VQC_FULLWAVE_CACHE=0` to disable)

## Phase 2 remaining

- (none — Meep source-imprint, RCWA stack, slab charge at affordable res, and disk cache are in)
